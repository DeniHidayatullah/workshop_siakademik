...
echo "<td><center>
<a class='btn btn-primary btn-xs' title='Edit Data' href='?view=jurusan&act=detail&id=$r[kode_jurusan]'>
<span class='glyphicon glyphicon-search'></span></a>
<a class='btn btn-success btn-xs' title='Edit Data' href='?view=jurusan&act=detail&id=$r[kode_jurusan]'>
<span class='glyphicon glyphicon-edit'></span></a>
<a class='btn btn-danger btn-xs' title='Delete Data' href='?view=jurusan&hapus=$r[kode_jurusan]'>
...
echo "<scrip>document.location='index.php?view=jurusan';</script>";
}
?>
</tbody>
</table>
...
<tr><tr> widht='140px' scope='row'>Kode Jurusan</th> <td>$s[kode_jurusan]</td></tr>
...
<tbody>
<input type = 'hidden' name= 'id' value='$s[kode_jurusan]'>
<tr><th widht='140px' scope='row'>Kode Jurusan
</th><td><input type = 'text' class='form-control' name='a' value='$s[kode_jurusan]'> </td></tr>
...
<tr><input  type ='text' class='form-control' name='f' value='$s[kompetensi_khusus]'></td></tr>
<tr><th scope='row'>Pejabat</th>                <td><input type='text' class='form-control' name='g' value='$s[pejabat]'></td></tr>
<tr><th scope='row'>Jabatan</th>                <td><input type='text' class='form-control' name='d' value='$s[jabatan]'></td></tr>
