...
while($r=mysqli_fetch_array($tampil)){
    ...
    if($_SESSION[level]!='kepala'){
        echo "<td><center>
        <a class='btn btn-succes btn-xs' title='Edit Data' href=''index.php?view=kelompokmapel&act=edit&id=$r[id_kelompok_mata_pelajaran]'>
        <span class='glypicon glyphicon-edit></span></a>
        <a class='btn btn-danger btn-xs' title=Delete Data' href=''index.php?view=kelompokmapel&hapus=$r[id_kelompok_mata_pelajaran]'>
...
if (isset($_GET[hapus])){
    mysqli_query($_koneksi,"DELETE FROM kelompok_mata_pelajaran where id_kelompok_mata_pelajaran='$_GET[hapus]'");
    echo "<script>document.location='index.php?view=kelompokmapel';</sript>";
}
?>
</tbody>
</table>
...
<table class='table table-condensed table-bordered'>
<tbody>
<tr><th 'width=120px' scope='row'>Jenis</th> <td><input type='text' class='form-control' name='b'> </td></tr>
