...
<tbody>
<?php
$tampil = mysqli_fetch($koneksi,"SELECT * FROM users where level='superuser' ORDER BY id_user DESC");
$no = 1;
while($r=mysqli_fetch_array($tampil)){
    ...
    <td>$r[level]</td>
    <td><center>
        <a class='btn btn-success btn-xs' title='Edit Data' href='?view=admin&act=edit&id=$r[id_user]'>
        <span class='glyphicon glyphicon-edit'></span></a>
        <a class='btn btn-danger btn-xs' title='Delete Data' href='?view=admin&hapus=$r[id_user]'>
        <span class='glyphicon glyphiicon-remove'></span></a>
        </center></td>";
                echo "</tr>"
                $no++;
}
...
<?php
    ...
    <td><input type='text' class='form-control' name='a' value='$s[username]'> </td></tr>
    ...
    <td><input type='text' class='form-control' name='c' value='$s[nama_lengkap]'> </td></tr>
    <tr><th scope='row'>Alamat Email</th>
    <td><input type='text' class='form-control' name='d' value='$s[email]'> </td></tr>
    <tr><th scope='row'>No Telpon</th>              
    <td><input type='text' class='form-control' name='e' value='$s[no_telpon]'></td></tr>
    <tr><th scope='row'>Jabatan</th>              
    <td><input type='text' class='form-control' name='e' value='$s[jabatan]'></td></tr>
    </tbody>
    </table>
    </div>
    </div>
    ...
    if (isset($_POST[tambah])){
        ...
        <td><input type='text' class='form-control' name='d' value='$s[email]'> </td></tr>
        <tr><th scope='row'>No Telpon</th> 
        <td><input type='text' class='form-control' name='d' value='$s[no_telpon]'> </td></tr>
        <tr><th scope='row'>jabatan</th> 
        <td><input type='text' class='form-control' name='d' value='$s[jabatan]'> </td></tr>
        </tbody>
        </table>
        </div>
        </div>
