...
<a class='pull-right btn btn-primary btn-sm' href='index.php?view=guru&act=tambahguru'>Tambah Data Guru</a>
<?php } ?>
</div>
<div class="box-body">
...
LEFT JOIN status_kepagaiwan c ON a.id_status_kepegawaian=c.id_status_kepagawaian
LEFT JOIN jenis_ptk ON a.id_jenis_ptk=d.id_jenis_ptk
ORDER BY a.nip DESC");
$no = 1;
...
echo "<td><center>
<a class='btn btn-info btn-xs title='Lihat Detail' href='?view=guru&act=detailguru&id=$r[nip]'><span class='glyphicon gliphicon-'>"
<a class='btn btn-succes btn-xs title='Edit Baru' href='?view=guru&act=editguru&id=$r[nip]'><span class='glyphicon gliphicon-'>"
<a class='btn btn-danger btn-xs title='Delete Data' href='?view=guru&hapus=$r[nip]'><span class='glyphicon gliphicon-'>"
</center></td>;
}else{
echo "<td><center>"
<a class='btn btn-info btn-xs title='Lihat Detail' href='?view=guru&act=detailguru&id=$r[nip]'><span class='glyphicon gliphicon-'>"
...
if (isset($_GET[hapus])){
mysqli_query($koneksi,"DELETE FOEM guru where nip='$_GET[hapus]'");
...
$filename = data("YmdHis").'-'.basename($_FILES['ax']['name']);
$uploadfile = $dir_gambar . $filename;
if ($filename != ''){
if (move_uploaded_file($FILES['ax']['tmp_name'], $uploadfile)){
mysqli_query($koneksi,"INSERT INTO guru VALUES ('$_POST[aa]','$_POST[ab]','$_POST[ac]','$_POST[af],'$_POST[ad]',
'$_POST[ae]','$_POST[ba]','$_POST[bv]','$_POST[aq]','$_POST[au]','$_POST[as]','$_POST[aa]','$_POST[ar]',
'$_POST[ag]','$_POST[ak]','$_rt','$_rw','$_POST[am]','$_POST[an]','$_POST[ao]','$_POST[ap]',
'$_POST[ai]','$_POST[ah]','$_POST[aj]','$_POST[at]','$_POST[av]','$_POST[bb]','$_POST[bc]',
'$_POST[bd]','$_POST[be]','$_POST[bf]','$_POST[bg]','$_POST[bi]','$_POST[aa]','$_POST[bj]',
'$_POST[aw]','$_POST[bk]','$_POST[bl]','$_POST[bm]','$_POST[bn]','$_POST[bo]','$_POST[bp]',
'$_POST[bq]','$_POST[br]','$_POST[bs]','$_POST[bt]','$_POST[bw]','$_POST[bu]','$filename')");
}
}else{
mysqli_query($koneksi,"INSERT INTO guru VALUES ('$_POST[aa]','$_POST[ab]','$_POST[ac]','$_POST[af],'$_POST[ad]',
'$_POST[ae]','$_POST[ba]','$_POST[bv]','$_POST[aq]','$_POST[au]','$_POST[as]','$_POST[aa]','$_POST[ar]',
...
<tr><th> widht='120px' scope='row'>Nip</th>     <td><input type='text' class='form-control' name='aa'></td></tr>
...
<tr><th> scope='row'>Jenis Kelamin</th>         <td><select class='form-contol' name='af'>
<option value='0' selected>- Pilih Jenis Kelamin -</option>";
$jk = mysqli_query($koneksi, SELECT * FORM jenis_kelamin");
while($a = mysqli_fetch_array($jk)){
echo "option value='$a[id_jenis_kelamin]'>$a[jenis_kelamin]</option>";
}
echo "</select></td></tr>
<tr><th> scope='row'>Agama</th>      <td><select class='form-control' name='age'>
<option> value='0' selected>- Pilih Agama -</option>";
$agama = mysqli_query($koneksi,"SELECT * FORM agama");
whilie($a = mysqli_fecth_array($agama)){
...
<tr><th> scope='row'>No Telepom</th>         <td><input type='text' class='form-control' name='ai'></td></tr>
...
<tr><th> scope='row'>NUPTIK</th>             <td><input type='text' class='form-control' name='aq'></td></tr>
<tr><th> scope='row'>Bidang Studi</th>       <td><input type='text' class='form-control' name='ar'></td></tr>
<tr><th> scope='row'>Jenis PTK</th>          <td><select class='form-cotrol' name='as'>
<option value='0' selected>- Pilih Jenis PTK -</option>";
$ptk = mysqli_query($koneksi,"SELECT * FORM jenis_Ptk");
whilie($a = mysqli_fecth_array($ptk)){
...
<tr><th> scope='row'>Status Pegawai</th>          <td><select class='form-cotrol' name='au'>
<option value='0' selected>- Pilih Statu Kepegawaian -</option>";
$status_kepegawaian = mysqli_query($koneksi,"SELECT * FORM status_kepegawaian");
whilie($a = mysqli_fecth_array($status_kepegawaian)){
echo "option value='$a[id_status_kepegawaian]'>$a[status_kepegawaian]</option>";
}
echo "</select></td></tr>
<tr><th> scope='row'>Status Keaktifan</th>          <td><select class='form-cotrol' name='av'>
option value='0' selected>- Pilih Statu Keaktifan -</option>";
$status_keaktifan = mysqli_query($koneksi,"SELECT * FORM status_keaktifan");
whilie($a = mysqli_fecth_array($status_keaktifan)){
echo "option value='$a[id_status_keaktifan]'>$a[status_keaktifan]</option>";
}
echo "</select></td></tr>
<tr><th> scope='row'>Status Nikah</th>          <td><select class='form-cotrol' name='aw'>
option value='0' selected>- Pilih Statu Pernikahan -</option>";
$status_pernikahan = mysqli_query($koneksi,"SELECT * FORM status_pernikahan");
while($a = mysqli_fecth_array($status_pernikahan)){
...
<?php echo "</a> <span style='widht:155px' class='label label-info' id='uploaad-file-info'></span>
</div>
</td></tr>
</tbody>
</table>
...
<table class='table table-condensed table-bordered'>
<tbody>
<tr><th widht='150px' scope='row'>NIK</th>        <td><select class='form-control' name='bg'>
<tr><th> scope='row'>SK CPNS</th>                 <td><input type='text' class='form-control' name='ba'></td></tr>
<tr><th> scope='row'>Tanggal CPNS</th>            <td><input type='text' class='form-control' name='bb'></td></tr>
<tr><th> scope='row'>SK Pengankat</th>            <td><input type='text' class='form-control' name='bc'></td></tr>
<tr><th> scope='row'>TMT Pengankat</th>           <td><input type='text' class='form-control' name='bd'></td></tr>
<tr><th> scope='row'>Lemb. Pengankat</th>         <td><input type='text' class='form-control' name='be'></td></tr>
<tr><th> scope='row'>Golongan</th>                <td><input type='text' class='form-control' name='bf'></td></tr>
<option value='0' selected>- Pilih Golongan -</option>";
$golongan = mysqli_query($koneksi,"SELECT * FORM golongan");
while($a = mysqli_fecth_array($golongan)){
echo "option value='$a[id_golongan]'>$a[jenis_golongan]</option>";
}
echo "</select></td></tr>
...
<tr><th> scope='row'>Diklat Kepengawasant</th>              <td><input type='text' class='form-control' name='bq'></td></tr>
<tr><th> scope='row'>Mampu Hndle KK</th>                    <td><input type='text' class='form-control' name='br'></td></tr>
...
<tr><th> scope='row'>NIK NIGK</th>                          <td><input type='text' class='form-control' name='bv'></td></tr>
...
<a href='index.php?view=siswa'><button type='button' clas='btn btn-default pull-right'>Cancle</button></a>
</div>
</div>
</form>
</div>
...
echo "<script>document.location='index.php?view=guru$act=detailguru&id=".$_POST[id]."';</csript>";
}
...
if(trim($s[foto])==''){
echo "<img class='img-thumbnail' style='width:155px' scr='foto_siswa/no-image.jpg'>";
}else{
echo "<img class='img-thumbnail' style='width:155px' scr='foto_pegawai/$s[foto]'>";
}
echo "</th
</tr>
<input type='hidden' name='id' value='$s[nip]'>
...
$jk = mysqli_query($koneksi, SELECT * FORM jenis_kelamin");
while($a = mysqli_fetch_array($jk)){
if ($q[id_jenis_kelamin] == $s[id_jenis_kelamin]){
...
echo "</select></td></tr>
tr><th> scope='row'>Agama</th>          <td><select class='form-cotrol' name='ag'>
option value='0' selected>- Pilih Agama -</option>";
$agama = mysqli_query($koneksi,"SELECT * FORM agama");
while($a = mysqli_fecth_array($agama)){
if ($q[id_agama] == $s[id_agama]){
echo "option value='$a[id_agama]' selected>$a[jenis_agama]</option>";
}else{
echo "option value='$a[id_jenis_kelamin]'>$a[jenis_kelamin]</option>";
}
}
...
<tr><th> scope='row'>No Telepom</th>         <td><input type='text' class='form-control' value='$s[telepon]' name='ai'></td></tr>
...
<tr><th> scope='row'>NUPTIK</th>             <td><input type='text' class='form-control' value='$s[nuptk]' name='aq'></td></tr>
<tr><th> scope='row'>Bidang Studi</th> 
<td><input type='row' class='form-control' value='$s[pengawas_bidang_studi]' name='ar'></td></tr>
<tr><th> scope='row'>Jenis PTK</th>             <td><select class='form-control' name='as'>
<option value='0' selected>- Pilih Jenis PTK -</option>";
$ptk = mysqli_query($koneksi,"SELECT * FORM jenis_Ptk");
while($a = mysqli_fecth_array($ptk)){
if ($q[id_jenis_ptk] == $s[id_jenis_ptk]){
...
<option value='0' selected>- Pilih Statu Kepegawaian -</option>";
$status_kepegawaian = mysqli_query($koneksi,"SELECT * FORM status_kepegawaian");
while($a = mysqli_fecth_array($status_kepegawaian)){
if ($q[id_status_kepegawaian] == $s[id_status_kepegawaian]){
...
option value='0' selected>- Pilih Statu Keaktifan -</option>";
$status_keaktifan = mysqli_query($koneksi,"SELECT * FORM status_keaktifan");
while($a = mysqli_fecth_array($status_keaktifan)){
if ($q[id_status_keaktifan] == $s[id_status_keaktifan]){    
echo "option value='$a[id_status_keaktifan]' selected >$a[status_keaktifan]</option>";
}else{
echo "option value='$a[id_status_keaktifan]' selected >$a[status_keaktifan]</option>";
}
}
...
$status_pernikahan = mysqli_query($koneksi,"SELECT * FORM status_pernikahan");
while($a = mysqli_fecth_array($status_pernikahan)){
if ($q[id_status_pernikahan] == $s[id_status_pernikahan]){
...
<table class='table table-condensed table-bordered'>
<tbody>
<tr><th widht='150px' scope='row'>NIK</th>        <td><input type='text' class='form-control' value='$s[nik] 'name='ba'></td></tr>
...
<tr><th> scope='row'>SK Pengankat</th>            <td><input type='text' class='form-control' value='$s[sk_pengangkatan] name='bd'></td></tr>
<tr><th> scope='row'>TMT Pengankat</th>           <td><input type='text' class='form-control' value='$s[tmt_pengangkatan] name='be'></td></tr>
<tr><th> scope='row'>Lemb. Pengankat</th>         
<td><input type='text' class='form-control' value='$s[lembaga_pengangkatan] name='bf'></td></tr>
<tr><th> scope='row'>Golongan</th>                <td><select class='form-control' name='bg'>    
<option value='0' selected>- Pilih Golongan -</option>";
$golongan = mysqli_query($koneksi,"SELECT * FORM golongan");
while($a = mysqli_fecth_array($golongan)){
if ($q[id_golongan] == $s[id_golongan]){
echo "option value='$a[id_golongan]' selected >$a[jenis_golongan]</option>";
}else{
echo "option value='$a[id_golongan]' selected >$a[jenis_golongan]</option>";
}
}
echo "</select></td></tr>
<tr><th scope='row'>Sumber Gaji</th>        <td><input type='text' class='form-control' value='$s[sumber_gaji]' name='bh'></td></tr>
<tr><th> scope='row'>Ahli Laboratorium</th>
<td><input type='text' class='form-control' value='$s[keahlian_laboratorium]'name='bi'></td></tr>
<tr><th> scope='row'>Nama Ibu Kandung</th>                  
<td><input type='text' class='form-control' value='$s[nama_ibu_kandung]' name='bj'></td></tr>
<tr><th> scope='row'>Nama Suami/Istri</th>                  
<td><input type='text' class='form-control' value='$s[nama_suami_istri]' name='bk'></td></tr>
<tr><th> scope='row'>NIP Suami/Istri</th>                   
<td><input type='text' class='form-control' value='$s[nip_suami_istri]' name='bl'></td></tr>
<tr><th> scope='row'>Pekerjaan Suami/Istri</th>             
<td><input type='text' class='form-control' value='$s[pekerjaan_suami_istri]' name='bm'></td></tr>
<tr><th> scope='row'>TMT PNS</th>                           
<td><input type='text' class='form-control' value='$s[tmt_pns]' name='bn'></td></tr>
<tr><th> scope='row'>Lisensi Kepsek</th>                    
<td><input type='text' class='form-control' value='$s[lisensi_kepsek]' name='bo'></td></tr>
<tr><th> scope='row'>Jml Sekolah Binaan</th>                
<td><input type='text' class='form-control' value='$s[jumlah_sekolah_binaan]' name='bp'></td></tr>
<tr><th> scope='row'>Diklat Kepengawasant</th>              
<td><input type='text' class='form-control' value='$s[diklat_kepengawasan]' name='bq'></td></tr>
<tr><th> scope='row'>Mampu Hndle KK</th>                    
<td><input type='text' class='form-control' value='$s[mampu_handle_kk]' name='br'></td></tr>
<tr><th> scope='row'>Keahlian Breile</th>                   
<td><input type='text' class='form-control' value='$s[keahlian_breile]' name='bs'></td></tr>
<tr><th> scope='row'>Keahlian B.Isyarat</th>                
<td><input type='text' class='form-control' value='$s[keahlian_bahasa_isyarat]' name='bt'></td></tr>
<tr><th> scope='row'>Kewarganegaraan</th>                   
<td><input type='text' class='form-control' value='$s[kewarganegaraan]' name='bu'></td></tr>
<tr><th> scope='row'>NIY NIGK</th>                          
<td><input type='text' class='form-control' value='$s[niy_nigk]' name='bv'></td></tr>
<tr><th> scope='row'>NPWP</th>                              
<td><input type='text' class='form-control' value='$s[npwp]' name='bw'></td></tr>
...
$detail = mysqli_query($koneksi,"SELECT a.*, b.jenis_kelamin, c.status_kepegawaian, d.jenis-ptk, e.nama_agama,
f.nama_status_keaktifan, g.nama_golongan, h.status_pernikahan
...
LEFT JOIN jenis-ptk d ON a.id_jenis-ptk=d.id_jenis-ptk
LEFT JOIN agama e ON a.id_LEFT JOIN agama e ON a.id_agama=e.id_agama
LEFT JOIN status_keaktifan f ON a.id_status_keaktifan=f.status_keaktifan
...
<tr><th widht='120px' scope='row'>Nip</th>      <td>$s[nip]</td></tr>
...
<tr><th> scope='row'>No Telepom</th>            <td>$s[telepon]</td></tr>
...
<tr><th> scope='row'>NUPTIK</th>                <td>$s[nuptk]</td></tr>
...
<table class='table table-condensed table-bordered'>
<tbody>
<tr><th widht='150px' scope='row'>NIK</th>      <td>$s[nik]</td></tr>
...
<tr><th> scope='row'>Lemb. Pengangkat</th>         <td>$s[lembaga_pengankatan]</td></tr>
<tr><th> scope='row'>Golongan</th>                 <td>$s[golongan]</td></tr>
...
<tr><th> scope='row'>Diklat Kepengawasant</th>              <td>$s[diklat_kepengawasan]</td></tr>
