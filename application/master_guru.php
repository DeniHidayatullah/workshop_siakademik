              ...
              <form method='POST' class='form-horizontal' action='' enctype='multipart/form-data'>
                <div class='col-md-6'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Alamat Email</th>           <td><input type='text' class='form-control' name='ai'></td></tr>
                    <tr><th scope='row'>Alamat</th>                 <td><input type='text' class='form-control' name='aj'></td></tr>
                    <tr><th scope='row'>RT/RW</th>                  <td><input type='text' class='form-control' value='00/00' name='ak'></td></tr>
                    <tr><th scope='row'>Dusun</th>                  <td><input type='text' class='form-control' name='al'></td></tr>
                    <tr><th scope='row'>Kelurahan</th>              <td><input type='text' class='form-control' name='am'></td></tr>
                    <tr><th scope='row'>Kecamatan</th>              <td><input type='text' class='form-control' name='an'></td></tr>
                ...
                <div class='col-md-6'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                  <tr><th width='150px' scope='row'>TMT</th>      <td><input type='text' class='form-control' name='ba'></td></tr>
                  <tr><th scope='row'>Jenis PTK</th>              <td><select class='form-control' name='bb'> 
                                                                  ...
                                                                  echo "</select></td></tr>
                    <tr><th scope='row'>Status Pegawai</th>         <td><select class='form-control' name='bc'> 
                                                                  ...
                                                                  echo "</select></td></tr>
                    <tr><th scope='row'>Status Keaktifan</th>       <td><select class='form-control' name='bd'> 
    ...
    echo "<div class='col-md-12'>
              ...
              <form method='POST' class='form-horizontal' action='' enctype='multipart/form-data'>
                ...
                <div class='col-md-5'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                  <tr><th scope='row'>TMT</th>                   <td><input type='text' class='form-control' value='$s[tmt]' name='ba'></td></tr>
                  <tr><th scope='row'>Jenis PTK</th>              <td><select class='form-control' name='bb'> 
                                                                          <option value='0' selected>- Pilih Jenis PTK -</option>"; 
                                                                            $ptk = mysqli_query($koneksi,"SELECT * FROM jenis_ptk");
                                                                            while($a = mysqli_fetch_array($ptk)){
