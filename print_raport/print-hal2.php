...
<body onload="window.print()">
    ...
    <table style='font-size:15px' width='100%'>
        ...
        <tr>
            ...
            <td width='10px'> : </td>
            <td> <?php echo "$s[tempat_lahir], " . tgl_raport($s[tanggal_lahir]); ?></td>
        </tr>
        <tr>
            <td>4.</td>
        ...
        <tr>
            <td>10.</td>
            <td width='190px'>Sekolah Asal (SMP/MTs)</td>
            <td width='10px'> : </td>
            <td> <?php echo ""; ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td width='190px'>Pada Tanggal</td>
            <td width='10px'> : </td>
            <td> <?php echo tgl_raport(date('Y-m-d')); ?></td>
        </tr>
        <tr>
            <td>12.</td>
        ...
        <tr>
            ...
            <td width='10px'> : </td>
            <td> <?php echo "$s[no_telpon_ayah]"; ?></td>
        </tr>
        <tr>
            <td>13.</td>
        ...
        <tr>
            ...
            <td width='10px'> : </td>
            <td> <?php echo "$s[pekerjaan_ayah]"; ?></td>
        </tr>
        <tr>
            <td></td>
            <td width='190px'>b. Ibu</td>
            <td width='10px'> : </td>
            <td> <?php echo "$s[pekerjaan_ibu]"; ?></td>
        </tr>
        <tr>
            <td>14.</td>
        ...
        <tr>
            <td></td>
            <td width='190px'>d. Pekerjaan</td>
            <td width='10px'> : </td>
            <td> <?php echo "$s[pekerjaan_wali]"; ?></td>
        </tr>
    </table>
    <br><br><br>
    <table width='40%' style='float:right'>
        <tr>
            <td>Jember, <?php echo tgl_raport(date('Y-m-d')); ?> <br>
                Kepala Sekolah,<br><br><br><br>


                <b>Dwi Anggraeni<br>
                    NIP : 196209051987031007</b></td>
        </tr>
    </table>
</body>
