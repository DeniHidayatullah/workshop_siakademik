<section class="sidebar">
  ...
  <ul class="sidebar-menu">
    ...
    <li><a href="index.php?view=jadwalmapel"><i class="fa fa-tag"></i> <span>Jadwal Pelajaran</span></a></li>
    <li><a href="index.php?view=absensi"><i class="fa fa-th-large"></i> <span>Absensi Siswa</span></a></li>
    <li class="treeview">
